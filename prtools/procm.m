%PROCM Process one-by-one a set of objects in a datafile/dataset/cell array
%
...
%
% SEE ALSO
% DATASETS, DATAFILES, IM2OBJ, DATA2IM, FILTM
...
function varargout = procm(varargin)
  ...
  if ischar(varargin{1}), varargin = {[] varargin{:}}; end
